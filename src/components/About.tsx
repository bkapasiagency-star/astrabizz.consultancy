      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-24">
          ...
          <div ref={statsRef} className="lg:col-span-5 grid grid-cols-2 gap-4">
            <div data-stat-card className="card-lift p-6 rounded-2xl bg-brand-light dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800 flex flex-col items-center text-center">
