        ...
        <div className="mb-24">
          ...
          <div className="relative why-swiper-wrap">
            <Swiper
              ...
              effect="creative"
              creativeEffect={{
                prev: { shadow: true, translate: ['-102%', 0, -200], rotate: [0, 0, -4] },
                next: { shadow: true, translate: ['102%', 0, -200], rotate: [0, 0, 4] },
              }}
              ...
              className="!pb-14 !px-1 !overflow-visible sm:!overflow-hidden"
            >
