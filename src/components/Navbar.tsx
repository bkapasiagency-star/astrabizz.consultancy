      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <a href="#" onClick={(e) => { e.preventDefault(); scrollToTop(); }} className="cursor-pointer">
            <Logo tagline taglineClassName="hidden sm:block" />
          </a>
                      ...
                      {INDUSTRIES.map((ind) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <span className="text-sm font-semibold text-slate-800 dark:text-slate-200 group-hover:text-brand-dark dark:group-hover:text-brand-primary transition-colors block">{ind.name}</span>
